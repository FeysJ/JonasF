...
cat << EOF | tee -a /etc/nginx/conf.d/wordpress.conf
server {
listen 80;

server_name $ipadres;  ## thematrix.local www.thematrix.local
root /usr/share/nginx/html/wordpress;
index index.php index.html index.htm;
listen 443 ssl http2 default_server; #https en http/2
listen [::]:443 ssl http2 default_server; #https en http/2       
