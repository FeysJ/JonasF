...
function BepaalAbsolutePaden {
    ...
    if ($keuze -eq ""){
        $csv = "C:\Users\Jonas\Documents\school\2022-2023 semester 2\lab\SEP-2223-sep-2223-t02\opdracht_Email_server\InstallScripts\paths.csv"
        ...
        foreach ($PadReeks in $Padfile) {
            ...
            Write-host ("Het absolute pad van het postInstallScript wordt: $global:postInstallScript`n")
