...
$vmname = Read-Host "Naam van de machine"
...
$iso = Read-Host "Geef het absolute pad van het iso-bestand in, zonder aanhalingstekens"
...
$vdipath = Read-Host "Geef het absolute pad van de map waar je vdi-bestand wilt plaatsen. Zonder aanhalingstekens"
ControleerPad($vdipath)

$gedeeldeMap = Read-Host "Geef het absolute pad van de map die gedeeld mag worden met de vm. Zonder aanhalingstekens"
ControleerPad($gedeeldeMap)

$postInstallScript = Read-Host "Geef het absolute pad van het post-install script in, zonder aanhalingstekens"
