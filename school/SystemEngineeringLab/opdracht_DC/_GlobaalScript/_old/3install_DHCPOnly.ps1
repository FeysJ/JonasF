...
function InstallatieDHCP ( $dhcpserveradres, $ServerName, $ServerForest ) {
    ...
    # compname wordt agentsmith.thematrix.local
        ...
        $testdhcp = "normale variabele"
        invoke-command -ScriptBlock {
            $Global:testdhcp=Get-DhcpServerInDC 
            write-host "object is in block: `n$global:testdhcp"  } 2> $null 
        write-host "object is buiten block: `n$global:testdhcp"
        write-host "object is buiten block(no global): `n$testdhcp"
